...
TEST(operator_tests, op_modulus) {
    ...
    // TODO check how to assert throw in googletest
    //for (int i = 0; i < s_samples; i++)
    //{
    //    tempByteArray1 = GetRandomByteArray(s_random);
    //    tempByteArray2 = { 0 };
    ...
    //VerifyIdentityString(BigInteger::Parse(int_max) + 1 + " " + int_max + " b%", int_max + "");
    //VerifyIdentityString(BigInteger::Parse(int64_max) + 1 + " " + int64_max + " b%", int64_max + "");
    ...
    //SEGFAULT from here
    //// Axiom: X%1 = 0
    //VerifyIdentityString(BigInteger::One() + " " + int_max + " b%", BigInteger::Zero().ToString());
    //VerifyIdentityString(BigInteger::One() + " " + int64_max + " b%", BigInteger::Zero().ToString());
