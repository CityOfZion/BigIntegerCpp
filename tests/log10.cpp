...
TEST(log_tests, log10) {
    ...
    VerifyLogString(int32_min + " uLog10");

    // Log Method - Int32.MinValue-1
    VerifyLogString(int32_min + " -1 b+ uLog10");

    // Log Method - Int32.MinValue+1
    VerifyLogString(int32_min + " 1 b+ uLog10");

    // Log Method - Int32.MaxValue
    VerifyLogString(int32_max + " uLog10");

    // Log Method - Int32.MaxValue-1
    VerifyLogString(int32_max + " -1 b+ uLog10");
    ...
    VerifyLogString(int64_min + " uLog10");

    // Log Method - Int64.MinValue-1
    VerifyLogString(int64_min + " -1 b+ uLog10");

    // Log Method - Int64.MinValue+1
    VerifyLogString(int64_min + " 1 b+ uLog10");

    // Log Method - Int64.MaxValue
    VerifyLogString(int64_max + " uLog10");

    // Log Method - Int64.MaxValue-1
    VerifyLogString(int64_max + " -1 b+ uLog10");
