...
public:
    ...
    static byte_array Max(byte_array bytes1, byte_array bytes2);
    ...
    static byte_array Not(byte_array bytes);
    static byte_array ShiftLeft(byte_array bytes1, byte_array bytes2);
    static byte_array ShiftLeftGrow(byte_array bytes);
    static byte_array ShiftLeftDrop(byte_array bytes);
    static byte_array ShiftRight(byte_array bytes);
    static byte_array SetLength(byte_array bytes, int size);
