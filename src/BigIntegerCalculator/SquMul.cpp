...
void BigIntegerCalculator::multiply(uint32_t* left, int leftLength, uint32_t* right, int rightLength, uint32_t* bits,
                                    int bitsLength) {
    assert(leftLength >= 0);
...
void BigIntegerCalculator::subtract_core(uint32_t* lhs, int lhsLength, uint32_t* rhs, int rhsLength, uint32_t* core,
                                         int coreLength) {
