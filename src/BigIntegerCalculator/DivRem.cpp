...
void BigIntegerCalculator::divide(uint32_t* lhs, int lhsLength, const uint32_t* rhs, int rhsLength, uint32_t* bits,
                                  int bitsLength) {
    assert(lhsLength >= 1);
    assert(rhsLength >= 1);
...
uint32_t
BigIntegerCalculator::subtract_divisor(uint32_t* lhs, int lhsLength, const uint32_t* rhs, int rhsLength, uint64_t q) {
    assert(lhsLength >= 0);
    assert(rhsLength >= 0);
    assert(lhsLength >= rhsLength);
    assert(q <= 0xFFFFFFFF);
...
bool
BigIntegerCalculator::divide_guess_too_big(uint64_t q, uint64_t valHi, uint32_t valLo, uint32_t divHi, uint32_t divLo) {
    assert(q <= 0xFFFFFFFF);
