...
public:
    ...
    static void
    pow_core(uint32_t power, const uint_array& modulus, BitsBuffer& value, BitsBuffer& result, BitsBuffer& temp);

    static void pow_core(uint32_t power, FastReducer& reducer, BitsBuffer& value, BitsBuffer& result, BitsBuffer& temp);

    static void pow_core(const uint_array& power, const uint_array& modulus, BitsBuffer& value, BitsBuffer& result,
                         BitsBuffer& temp);

    static void
    pow_core(const uint_array& power, FastReducer& reducer, BitsBuffer& value, BitsBuffer& result, BitsBuffer& temp);
    ...
    static void
    multiply(uint32_t* left, int leftLength, uint32_t* right, int rightLength, uint32_t* bits, int bitsLength);
    ...
    static void
    divide(uint32_t* lhs, int lhsLength, const uint32_t* rhs, int rhsLength, uint32_t* bits, int bitsLength);
...
private:
    ...
    static void
    add(const uint32_t* lhs, int lhsLength, const uint32_t* rhs, int rhsLength, uint32_t* bits, int bitsLength);

    static void add_self(uint32_t* lhs, int lhsLength, uint32_t* rhs, int rhsLength);

    static void
    subtract(const uint32_t* lhs, int lhsLength, const uint32_t* rhs, int rhsLength, uint32_t* bits, int bitsLength);

    static void
    subtract_core(uint32_t* lhs, int lhsLength, uint32_t* rhs, int rhsLength, uint32_t* core, int coreLength);
